...
# NOTE: Removed circular import from chatbot. Clients are initialized locally in this module.
...
def get_claude_response(system_prompt, user_prompt, is_json=False):
    ...
    try:
        ...
        (_, _claude_client)=_ensure_clients(); response = _claude_client.messages.create(
